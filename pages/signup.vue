<template>
    <div class="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 flex items-center justify-center p-4">
      <Head>
          <Title>Sign-up</Title>
          <Meta name="description" content="Sign-up to explore our blog and you can like, comment, share, posting blog that you want to share here."/>
        </Head>
      <div class="w-full max-w-md">
        ...
        <div class="bg-gray-800/40 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-gray-700/50">
          ...
          <div class="grid grid-cols-2 gap-4 mb-6">
            <button class="flex items-center justify-center gap-2 p-3 bg-white/5 hover:bg-white/10 rounded-lg border border-gray-700 transition-all duration-300">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              <label class="flex items-center">
                <input type="checkbox" class="w-4 h-4 rounded bg-gray-700 border-gray-600 text-purple-500 focus:ring-purple-500">
